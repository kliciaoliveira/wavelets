...
program wavelet
  ...
  do while (x .le. 3.0)
     y=-1.
     do while (y .le. 3.0)
        min_Interv=-4.                        ! *** j varia de 0 a 1 ****
        max_Interv=4.
        if ((x .ge. 0. .and. x .le. 2.0) .and. (y .ge. 0. .and. y .le. 2.0)) then     ! Restricao da funcao no intervalo [0,2] para X e Y
           Fxy=0.
           somaPai=0. ; fcPai=0.
           somaMae=0. ; fcMae=0.
           l=min_Interv
           j=0.
           k1=-1.                             ! *** k1 e k2 variando de 0 a 1 ***
           do while (k1 .le. 1)
              k2=-1.
              do while (k2 .le. 1.)
...
!              write(*,*)j
              k1=0.                         ! *** k1 e k2 variando de 0 a 1 ***
              do while (k1 .le. 1.)
                 k2=0.
                 do while (k2 .le. 1.)
...
!    endif
     ...
     if (lim_psi2_1 .lt. 0)inicialy=0.
     if (lim_psi2_1 .ge. 0 .and. lim_psi2_1 .lt. 2)inicialy=lim_psi2_1
     if (lim_psi2_1 .ge. 2)rescalc2=1;res2=0.
     ...
     if (lim_psi1_1 .lt. 0)inicialx=0.
     if (lim_psi1_1 .ge. 0 .and. lim_psi1_1 .lt. 2)inicialx=lim_psi1_1
     if (lim_psi1_1 .ge. 2)rescalc2=1;res2=0.
